...
class EntityTests_animateRotations : public ManualTests {
public:

    EntityTests_animateRotations():
        _animations(NULL),
		_entities(NULL),
		_fonts(NULL),
		_surfaces(NULL),
	...
	virtual ~EntityTests_animateRotations() {
		release();
	}
	void prepareTests();
...
#endif // _EntityTests_animateRotations_
