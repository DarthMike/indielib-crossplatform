...
TEST_FIXTURE(fontFixture,FONTMANAGER_ADDEXISTING_ADDOK) {
	CHECK(iLib->_fontManager->add(testFont, "font_small.png", "font_small.xml", IND_ALPHA, IND_32));
}

TEST_FIXTURE(fontFixture,FONTMANAGER_ADDNONEXISTINGIMG_ADDFAILS) {
	CHECK(!iLib->_fontManager->add(testFont, "BADBADBAD.png", "font_small.xml", IND_ALPHA, IND_32));
}

TEST_FIXTURE(fontFixture,FONTMANAGER_ADDNONEXISTINGXML_ADDFAILS) {
	CHECK(!iLib->_fontManager->add(testFont, "font_small.png", "BADBADBAD.xml", IND_ALPHA, IND_32));
}
